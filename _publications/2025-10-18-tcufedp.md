...
<img src="/images/VortexWorkshopMICRO2025.png" alt="FEDP Block Diagram" style="float:left; margin:10px 20px 10px 0; max-width:400px; width:100%; height:auto; border-radius:8px;" />
